...
FormList <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return FormList as a base R list.
    #' @examples
    ...
    #' @return the instance of FormList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Form]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return FormList in JSON format
    ...
    #'
    #' @return String representation of FormList
    toString = function() {
      self$toJSONString()
    },
...
# FormList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
