...
#' @field data  list(\link{Variable}) [optional]
...
VariableList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new VariableList class.
    #'
    ...
    #'
    #' @return VariableList as a base R list.
    #' @examples
    #' # convert array of VariableList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of VariableList
    #'
    #' @param input_json the JSON input
    #' @return the instance of VariableList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Variable]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return VariableList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to VariableList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of VariableList
    toString = function() {
      self$toJSONString()
    },
...
# VariableList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
