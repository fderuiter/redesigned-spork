...
------------- | ------------- | -------------
[**VariablesAPI_listVariables**](VariablesAPI.md#VariablesAPI_listVariables) | **GET** /studies/{studyKey}/variables | List variables (fields) in a study


# **VariablesAPI_listVariables**
```c
// List variables (fields) in a study
//
variable_list_t* VariablesAPI_listVariables(apiClient_t *apiClient, char *studyKey, int *page, int *size, char *sort, char *filter);
```
...
[variable_list_t](variable_list.md) *
