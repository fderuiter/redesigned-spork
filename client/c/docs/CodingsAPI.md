...
------------- | ------------- | -------------
[**CodingsAPI_listCodings**](CodingsAPI.md#CodingsAPI_listCodings) | **GET** /studies/{studyKey}/codings | List coding activities in a study


# **CodingsAPI_listCodings**
```c
// List coding activities in a study
//
coding_list_t* CodingsAPI_listCodings(apiClient_t *apiClient, char *studyKey, int *page, int *size, char *sort, char *filter);
```
