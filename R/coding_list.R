...
CodingList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CodingList class.
    #'
    ...
    #'
    #' @return CodingList as a base R list.
    #' @examples
    #' # convert array of CodingList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CodingList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CodingListObject <- list()
      if (!is.null(self$`metadata`)) {
        CodingListObject[["metadata"]] <-
          self$`metadata`$toSimpleType()
      }
      if (!is.null(self$`pagination`)) {
        CodingListObject[["pagination"]] <-
          self$`pagination`$toSimpleType()
      }
      if (!is.null(self$`data`)) {
        CodingListObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(CodingListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CodingList
    #'
    #' @param input_json the JSON input
    #' @return the instance of CodingList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Coding]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return CodingList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CodingList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of CodingList
    toString = function() {
      self$toJSONString()
    },
...
# CodingList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
