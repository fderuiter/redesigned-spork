...
InlineObject3 <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return InlineObject3 as a base R list.
    #' @examples
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`metadata`)) {
        InlineObject3Object[["metadata"]] <-
          self$`metadata`$toSimpleType()
      }
      return(InlineObject3Object)
    },
    ...
    #' @return the instance of InlineObject3
    ...
    #' @return InlineObject3 in JSON format
    ...
    #'
    #' @return String representation of InlineObject3
    toString = function() {
      self$toJSONString()
    },
...
# InlineObject3$unlock()
#
## Below is an example to define the print function
# InlineObject3$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
