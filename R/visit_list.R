...
VisitList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new VisitList class.
    #'
    ...
    #'
    #' @return VisitList as a base R list.
    #' @examples
    #' # convert array of VisitList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert VisitList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      VisitListObject <- list()
      if (!is.null(self$`metadata`)) {
        VisitListObject[["metadata"]] <-
          self$`metadata`$toSimpleType()
      }
      if (!is.null(self$`pagination`)) {
        VisitListObject[["pagination"]] <-
          self$`pagination`$toSimpleType()
      }
      if (!is.null(self$`data`)) {
        VisitListObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(VisitListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of VisitList
    #'
    #' @param input_json the JSON input
    #' @return the instance of VisitList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Visit]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return VisitList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to VisitList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of VisitList
    toString = function() {
      self$toJSONString()
    },
...
# VisitList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
