...
IntervalList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new IntervalList class.
    #'
    ...
    #'
    #' @return IntervalList as a base R list.
    #' @examples
    #' # convert array of IntervalList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert IntervalList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      IntervalListObject <- list()
      if (!is.null(self$`metadata`)) {
        IntervalListObject[["metadata"]] <-
          self$`metadata`$toSimpleType()
      }
      if (!is.null(self$`pagination`)) {
        IntervalListObject[["pagination"]] <-
          self$`pagination`$toSimpleType()
      }
      if (!is.null(self$`data`)) {
        IntervalListObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(IntervalListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of IntervalList
    #'
    #' @param input_json the JSON input
    #' @return the instance of IntervalList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Interval]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return IntervalList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to IntervalList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of IntervalList
    toString = function() {
      self$toJSONString()
    },
...
# IntervalList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
