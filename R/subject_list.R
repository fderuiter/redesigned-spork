...
SubjectList <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return SubjectList as a base R list.
    #' @examples
    ...
    toSimpleType = function() {
      SubjectListObject <- list()
      if (!is.null(self$`metadata`)) {
        SubjectListObject[["metadata"]] <-
          self$`metadata`$toSimpleType()
      }
      if (!is.null(self$`pagination`)) {
        SubjectListObject[["pagination"]] <-
          self$`pagination`$toSimpleType()
      }
      if (!is.null(self$`data`)) {
        SubjectListObject[["data"]] <-
    ...
    #' @return the instance of SubjectList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Subject]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return SubjectList in JSON format
    ...
    #'
    #' @return String representation of SubjectList
    toString = function() {
      self$toJSONString()
    },
...
# SubjectList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
