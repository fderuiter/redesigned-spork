...
//
interval_list_t*
IntervalsAPI_listIntervals(apiClient_t *apiClient, char *studyKey, int *page, int *size, char *sort, char *filter)
{
    ...
    // create the path
    char *localVarPath = strdup("/studies/{studyKey}/intervals");
    ...
    interval_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *IntervalsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = interval_list_parseFromJSON(IntervalsAPIlocalVarJSON);
        cJSON_Delete(IntervalsAPIlocalVarJSON);
