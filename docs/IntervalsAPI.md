...
------------- | ------------- | -------------
[**IntervalsAPI_listIntervals**](IntervalsAPI.md#IntervalsAPI_listIntervals) | **GET** /studies/{studyKey}/intervals | List intervals (visit definitions) in a study


# **IntervalsAPI_listIntervals**
```c
// List intervals (visit definitions) in a study
//
interval_list_t* IntervalsAPI_listIntervals(apiClient_t *apiClient, char *studyKey, int *page, int *size, char *sort, char *filter);
```
...
[interval_list_t](interval_list.md) *
