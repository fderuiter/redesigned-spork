# Org.OpenAPITools.Api.RecordRevisionsApi
...
# **ListRecordRevisions**
> RecordRevisionList ListRecordRevisions (string studyKey, int page = null, int size = null, string sort = null, string filter = null)
